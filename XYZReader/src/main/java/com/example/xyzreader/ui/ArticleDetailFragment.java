...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Check if the layout is horizontal. In that case, don't move the photo container's position
        if (mRootView.findViewById(R.id.horizontal_layout_container) == null) {
